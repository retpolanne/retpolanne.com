{
  ...
  em-websocket = {
    ...
    source = {
      ...
      rev = "8d2bd716c8622196958c400d237f33c097e96d67";
      sha256 = "16bhblacbgqa4mzdn75d6qcnvw19gbm5ddgksy01mpjrhif3qzzl";
      type = "git";
      url = "https://github.com/retpolanne/em-websocket";
    };
    version = "0.5.3";
  };
  eventmachine = {
  ...
  sass-embedded = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1b4wk7smg8cgrkgf6a17arn15yinjalqif57nsh5baygvalkp2fl";
      type = "gem";
    };
    version = "1.63.4";
